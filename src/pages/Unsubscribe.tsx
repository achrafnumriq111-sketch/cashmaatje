      ...
      <div className="w-full max-w-sm space-y-8 text-center">
        ...
        {state === "valid" && (
          <>
            ...
            <p className="text-sm text-muted-foreground">Klik om geen e-mails meer van Arcory te ontvangen.</p>
        ...
        <Link to="/" className="text-xs text-muted-foreground hover:text-foreground">Terug naar Arcory</Link>
      </div>
    </div>
  );
}
