      ...
      {loading ? (
        ...
        <motion.div variants={staggerContainer} initial="initial" animate="animate" className="grid gap-6 lg:grid-cols-2">
          <div className="space-y-4">
            <motion.h2 variants={cardVariant} className="text-lg font-semibold text-foreground">Activa</motion.h2>
          ...
          <div className="space-y-4">
            <motion.h2 variants={cardVariant} className="text-lg font-semibold text-foreground">Passiva</motion.h2>
